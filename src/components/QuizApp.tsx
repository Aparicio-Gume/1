...
export default function QuizApp() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "hsl(0 0% 7%)", padding: "1.5rem" }}>
      ...
      {[
        { photo: testimonial1, name: "Hermínio Mabiala", time: "há 2 minutos", likes: 15, text: "Quem ainda tá a duvidar é porque gosta de sofrer. Isso é dos truques mais frescos que já vi online. Recomendo mesmo!" },
        { photo: testimonial2, name: "Anabela Sitoe", time: "há 5 minutos", likes: 23, text: "Kkkk juro que pensei que era mentira, mas resolvi testar e não é! Já caiu 1.200 na minha conta do M-Pesa. Vocês são os melhores!" },
        { photo: testimonial3, name: "Lurdes Cumbe", time: "há 8 minutos", likes: 41, text: "Nunca pensei que responder perguntas simples me ia dar dinheiro. Já levantei duas vezes e caiu certinho no E-Mola. Obrigada Netflix!" },
        { photo: testimonial4, name: "Carlos Muiambo", time: "há 12 minutos", likes: 9, text: "Fiz o quiz em menos de 2 minutos e já tenho $850 para levantar. Partilhei com toda a família. Não parem com isso, por favor!" },
      ].map((t, i) => (
        <div
          key={i}
          style={{
